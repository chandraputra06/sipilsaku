<section class="relative overflow-hidden bg-[#FCF5EE]">
    ...
    <div class="relative min-h-[380px] sm:min-h-[460px] lg:min-h-[540px]">
        ...
        {{-- Content --}}
        <div class="relative z-[2] mx-auto flex min-h-[380px] max-w-[1240px] items-center justify-center px-6 py-14 text-center sm:min-h-[460px] lg:min-h-[540px] lg:px-8">
        ...
        <div class="absolute bottom-0 left-0 z-[3] w-full overflow-hidden leading-none">
            <svg viewBox="0 0 1440 120" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" class="block h-[68px] w-full sm:h-[78px] lg:h-[92px]">
                <path
